...
<div>
    <div class="min-w-full max-w-screen lg:h-[350px] h-max items-center">
        <div class="w-full max-w-screen owl-carousel h-full flex gap-2 items-center overflow-hidden p-2">
