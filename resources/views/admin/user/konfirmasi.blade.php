@extends('layouts.main', ['title' => 'Daftar User Belum Dikonfirmasi'])
<style>
  thead tr th {
    font-size: 0.9em;
    white-space: nowrap;
...
<div id="content" class="py-4">
  <div class="container-fluid">
    <h1 style="font-size: 1.5em">Daftar Registrasi User</h1>
    <div class="card">
      <div class="card-body">
                  ...
                  <tr>
                    ...
                    <td>
                      <div class="d-flex align-items-center" style="gap: 7px;">
                        ...
                        <form class="m-0" action="{{ route('admin.user.konfirmasi', $value->uuid) }}" method="POST">
                          @method('PUT')
                          @csrf
