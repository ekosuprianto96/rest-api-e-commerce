@extends('frontend.layouts.index', ['title' => 'Komisi Afiliasi'])
            ...
            <div class="grid grid-cols-12 relative w-full h-max gap-3">
                ...
                <div class="lg:col-span-9 col-span-12">
                    <div class="rounded-lg px-2 py-3 shadow-lg bg-white">
                        <div class="px-2">
                            @include('frontend.dashboard.contents.content-komisi-affiliasi', ['title' => 'Daftar Komisi Afiliasi Anda', 'chart' => $chart, 'komisi' => $komisi])
                        </div>
                    </div>
                </div>
            </div>
